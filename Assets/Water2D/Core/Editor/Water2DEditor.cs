        ...
        void OnSceneGUI()
        {
            ...
            if (WSpawner)
            {
               ...
               // EditorUtility.SetSelectedRenderState(WSpawner.GetComponent<MeshRenderer>(), EditorSelectedRenderState.Hidden);
                ...
                var fmh_1175_25_638962062207389896 = Quaternion.identity; newHandlePoint = (lTransform.position - Handles.FreeMoveHandle(
                ...
                var fmh_1214_91_638962062207433038 = Quaternion.identity; Vector3 newFreeHandlePoint = (Handles.FreeMoveHandle(lTransform.position,
